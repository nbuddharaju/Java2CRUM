...
public class IOrganizationService_Retrieve_OrganizationServiceFaultFault_FaultMessage extends java.lang.Exception{

    private static final long serialVersionUID = 1464687962463L;
    ...
    private java2crmpack.OrganizationServiceStub.OrganizationServiceFaultE faultMessage;
        ...
        public IOrganizationService_Retrieve_OrganizationServiceFaultFault_FaultMessage(java.lang.String s) {
           super(s);
        }

        public IOrganizationService_Retrieve_OrganizationServiceFaultFault_FaultMessage(java.lang.String s, java.lang.Throwable ex) {
          super(s, ex);
        }

        public IOrganizationService_Retrieve_OrganizationServiceFaultFault_FaultMessage(java.lang.Throwable cause) {
            super(cause);
        }
